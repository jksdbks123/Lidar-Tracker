...
import json
import torch
from PosteriorModel.TrackingNN import TrackingNet

class MOT_NN():
    def __init__(self,pcap_path,output_file_path,model_path,background_update_frame,ending_frame,d ,thred_s ,N ,
    ...
    def initialization(self):
        ...
        self.tracking_nn =  model
        self.tracking_nn.eval()
