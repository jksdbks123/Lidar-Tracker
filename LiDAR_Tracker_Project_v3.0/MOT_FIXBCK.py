...
class MOT():
    def __init__(self,input_file_path,output_file_path,thred_map_path, win_size, eps, min_samples,bck_radius = 0.5,missing_thred = 10
        ...
        self.thred_map_path = thred_map_path
        self.if_vis = if_vis
    ...
    def initialization(self):    
        ...
        thred_map = np.load(self.thred_map_path)
...
if __name__ == "__main__":
    ...
    input_file_path = r'D:\LiDAR_Data\MidTown\California\Fri\2021-12-9-11-0-0.pcap'
    thred_map_path = r'D:\LiDAR_Data\MidTown\California\Fri\thred_map_11.npy'
    mot = MOT(input_file_path,output_file_path,thred_map_path,**params)
    mot.initialization()
    mot.mot_tracking()
